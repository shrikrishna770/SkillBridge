...
function HomeSkeleton() {
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-12 animate-pulse">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 space-y-6">
          <div className="h-[300px] glass rounded-[2.5rem] border border-white/5" />
          <div className="space-y-4">
            <div className="h-8 w-48 bg-white/5 rounded-lg" />
            <div className="space-y-3">
              {[1, 2].map((i) => (
                <div key={i} className="h-24 glass rounded-2xl border border-white/5" />
              ))}
            </div>
          </div>
        </div>
        <div className="space-y-6">
          <div className="h-[250px] glass rounded-[2.5rem] border border-white/5" />
          <div className="h-[300px] glass rounded-[2.5rem] border border-white/5" />
        </div>
      </div>
    </div>
